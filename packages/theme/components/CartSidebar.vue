<template>
  <div id="cart">
    <SfSidebar v-e2e="'sidebar-cart'" :visible="isCartSidebarOpen" title="Cart" class="sf-sidebar--right"
      ...
      <transition name="sf-fade" mode="out-in">
        <div v-if="cartGetters.getTotalItems(cart)" key="my-cart" class="my-cart">
          <transition-group name="sf-fade" tag="div">
            <ProductCard name="product-card" class="product-card" v-for="(product, index) in cartGetters.getItems(cart)"
              :key="index + 'new'" :pName="cartGetters.getItemName(product)"
              :pPrice="cartGetters.getItemPrice(product).regular" :pImage="cartGetters.getItemImage(product)"
              :pCount="cartGetters.getItemQty(product)" :horizontalView="false" :deleteCard="true" :dropdownCouner="true"
      ...
      <div class="c-footer" v-if="cartGetters.getTotalItems(cart)">
        <Footer @buttonClick="footerClick" :totalPrice="cartGetters.getTotals(cart).total"
          :totalItem="cartGetters.getTotalItems(cart)" buttonText="checkout">
